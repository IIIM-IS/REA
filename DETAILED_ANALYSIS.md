...
### Project Overhead
- **Percentage** (any positive value): Treated as a percentage of the target and subtracted from it.
  - If value > 1, it is interpreted as a whole percent (e.g., 7 → 7%).
  - Target after overhead: `(grant_contractual + matching_funds) × (1 - overhead_pct)`

### Total Target
```
total_target = (grant_contractual + matching_funds) × (1 - overhead_pct)
```
